...
public class CalculatorTest {
    ...
    @Test
    @DisplayName("Test Assumtions")
    public void testAssumtions(){

        // Ketika environment variable PROFILE nilainya sama dengan DEV maka unit testnya akan dilanjutkan, namun
        // ketika tidak sama maka unit test method @Test akan dibatalkan di-ignore.
